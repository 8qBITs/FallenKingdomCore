...
public class Warp implements CommandCallable {
	...
	private final Optional<Text> desc = Optional.of(Text.of("Teleports you to a warp."));
    private final Optional<Text> help = Optional.of(Text.of("Teleports you to a warp."));
    private final Text usage = Text.of("/warp <name>");
	...
	public CommandResult process(CommandSource source, String arguments) throws CommandException {
		...
		if(args.length==0 || args[0]=="") {
			...
			if((wl = WarpStorage.getLocation(args[0].toLowerCase())) != null) {
				...
				p.setLocation(wl);
				msg.sendAction("&6Teleported to '"+args[0]+"'");
			} else {
	...
	public boolean testPermission(CommandSource source) {
		// TODO Auto-generated method stub
		return source.hasPermission("core.warp");
	}
